        ...
        <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="button1_link" name="button1_link" value="{{ old('button1_link') }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="button2_link" name="button2_link" value="{{ old('button2_link') }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
